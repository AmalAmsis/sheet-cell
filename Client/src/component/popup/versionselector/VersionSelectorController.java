...
//    }
    ...
    public void loadVersionToMenuBar() {
        ...
        int numOfVersion = selectedSheetViewController.getNumOfVersions();
    ...
    public void setVersionData(int version){
        int numOfChanges = selectedSheetViewController.getNumOfChangesInVersion(version);
